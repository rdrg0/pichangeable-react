...
export default function SignFlow() {
    return (
        <>
          <Sign>  
            <Titles >
                <FontMediumGray style={{fontSize: 24}}>Selecciona el perfil con el que te identificas</FontMediumGray>
                <FontSizeBig style={{fontSize: 44}}>¿Qué estás buscando?</FontSizeBig>
            </Titles>
            <Options>
            <Card> 
                <img src={public_cancha} alt="buscador_cancha" />
                <FontSizeMedium>Administrador</FontSizeMedium>
                <FontMediumGray>Tienes algún espacio deportivo que ofrecer</FontMediumGray>
            </Card>  
            <Card> 
